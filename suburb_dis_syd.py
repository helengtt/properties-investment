...
with open('./suburbs/sydney-nsw-2000.csv', 'w') as f:
    ...
    centre = next(obj for obj in data if obj['suburb_id'] == 'sydney-nsw-2000')
    centre_name = centre['suburb_id']
    suburbs = [obj for obj in data if 2000 <= obj['postcode'] <= 2155]
