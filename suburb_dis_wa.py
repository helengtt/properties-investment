...
with open('./suburbs/perth-wa-6000.csv', 'w') as f:
    ...
    centre = next(obj for obj in data if obj['suburb_id'] == 'perth-wa-6000')
    centre_name = centre['suburb_id']
    suburbs = [obj for obj in data if 6000 <= obj['postcode'] <= 6050]
    # suburbs.remove(centre)
