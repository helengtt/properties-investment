...
with open('./suburbs/brisbane-city-qld-4000.csv', 'w') as f:
    ...
    centre = next(obj for obj in data if obj['suburb_id'] == 'brisbane-city-qld-4000')
    centre_name = centre['suburb_id']
    suburbs = [obj for obj in data if 4000 <= obj['postcode'] <= 4110]
