...
with open('./suburbs/melbourne-vic-3000.csv', 'w') as f:
    ...
    centre = next(obj for obj in data if obj['suburb_id'] == 'melbourne-vic-3000')
    centre_name = centre['suburb_id']
    suburbs = [obj for obj in data if 3000 <= obj['postcode'] <= 3140]
